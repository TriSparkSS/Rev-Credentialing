            ...
            <div class="row align-items-center g-3">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input type="search" wire:model.live="search" class="form-control border-start-0" placeholder="Search form templates...">
                    </div>
                </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="text-center py-5 text-muted">No form templates found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $modalMode === 'create' ? 'Create Form Template' : 'Edit Form Template' }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" wire:model="formData.template_key" class="form-control @error('formData.template_key') is-invalid @enderror">
                                    @error('formData.template_key')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Version</label>
                                    <input type="text" wire:model="formData.version" class="form-control @error('formData.version') is-invalid @enderror">
                                    @error('formData.version')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Description</label>
                                    <textarea wire:model="formData.description" class="form-control @error('formData.description') is-invalid @enderror" rows="3"></textarea>
                                    @error('formData.description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="formTemplateActive" wire:model="formData.is_active">
