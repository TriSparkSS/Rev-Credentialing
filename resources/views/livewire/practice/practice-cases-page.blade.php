    ...
    <div class="container-fluid flex-grow-1 px-3 px-md-4 py-3 py-md-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-sm-6 col-md-4">
                <x-practice.stat-card label="Total Applications" :value="$cases->total()" />
            </div>
            <div class="col-sm-6 col-md-4">
                <x-practice.stat-card label="Active" :value="$activeCount" valueClass="text-primary" />
            </div>
            <div class="col-sm-6 col-md-4">
                <x-practice.stat-card label="Action Needed" :value="$actionCount" valueClass="text-warning" />
            </div>
        </div>
