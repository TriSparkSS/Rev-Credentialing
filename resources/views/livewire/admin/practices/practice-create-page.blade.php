    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="d-flex align-items-start justify-content-between mb-4">
                <div>
                    <h4 class="mb-1 fw-bold text-primary">Add Practice</h4>
                    <p class="text-muted mb-0">Create a practice profile, login user, and primary address.</p>
                </div>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        @error('userData.password') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <button class="btn btn-primary">Create Practice</button>
