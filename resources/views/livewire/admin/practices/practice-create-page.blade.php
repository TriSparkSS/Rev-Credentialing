        ...
        <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
            <div>
                <h4 class="fw-bold text-primary mb-1">
                    <i class="ti tabler-building-plus me-2"></i>Add Practice
                </h4>
                <p class="text-muted mb-0">Create a practice profile with locations, bank details, and credentialing documents.</p>
            </div>
        ...
        <div class="card-body p-4">
            <form wire:submit.prevent="save">
                ...
                <div class="mb-3 pb-3 border-bottom">
                    ...
                    <p class="text-muted small mb-0">Business identifiers, contact information, and login credentials.</p>
                </div>
                ...
                <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 pt-3 border-top">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ti tabler-check me-1"></i>Create Practice
                        </button>
                    </div>
                </div>
            </form>
