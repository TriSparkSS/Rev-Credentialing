...
new class extends Component {
    ...
    #[Computed]
    public function practiceName(): string
    {
        return $this->user?->practice?->legal_name ?? $this->user?->name ?? '';
    }
    ...
    public function actionItemsCount(): int
    {
        ...
        return app(PortalActionItemsService::class)->practiceActionCount($practice);
    }
};
?>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
            ...
            <li class="nav-item dropdown me-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 260px;">
                    ...
                    <li>
                        <a class="dropdown-item d-flex justify-content-between" href="{{ route('practice.action-items') }}">
                    ...
                    <li>
                        <a class="dropdown-item d-flex justify-content-between" href="{{ route('practice.documents') }}">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar">
                        <span class="avatar-initial rounded-circle bg-primary text-white">
                            {{ strtoupper(substr($this->practiceName ?: 'P', 0, 1)) }}
                        </span>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="dropdown-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-0">{{ $this->practiceName }}</h6>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('practice.profile') }}">
                            <i class="icon-base ti tabler-building-hospital icon-md me-3"></i>
