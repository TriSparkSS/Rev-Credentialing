<div>
    <div class="container-fluid flex-grow-1 px-3 px-md-4 py-3 py-md-4">
        <x-provider.page-header
            title="Upload Center"
            subtitle="Submit requested credentialing documents for your active applications."
        />
        ...
        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <select wire:model="selectedCaseId" class="form-select @error('selectedCaseId') is-invalid @enderror">
                                    ...
                                    @foreach($cases as $case)
                                        <option value="{{ $case->id }}">{{ $case->case_number }} — {{ $case->payer->name ?? '' }}</option>
                                    @endforeach
                                </select>
            ...
            <div class="{{ ($canUpload ?? true) ? 'col-lg-7' : 'col-12' }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr><th>Document</th><th>Case</th><th>Payer</th></tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">No outstanding document requests.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white">
                        <h6 class="fw-semibold mb-0">My Uploads</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
