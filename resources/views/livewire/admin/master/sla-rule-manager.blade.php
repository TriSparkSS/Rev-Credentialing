            ...
            <div class="row align-items-center g-3">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input type="search" wire:model.live="search" class="form-control border-start-0" placeholder="Search SLA rules...">
                    </div>
                </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="8" class="text-center py-5 text-muted">No SLA rules found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $modalMode === 'create' ? 'Create SLA Rule' : 'Edit SLA Rule' }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" wire:model="formData.rule_key" class="form-control @error('formData.rule_key') is-invalid @enderror">
                                    @error('formData.rule_key')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" wire:model="formData.business_days" class="form-control @error('formData.business_days') is-invalid @enderror" min="1">
                                    @error('formData.business_days')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Action</label>
                                    <select wire:model="formData.action" class="form-select @error('formData.action') is-invalid @enderror">
                                        @foreach ($actions as $key => $label)
                                            <option value="{{ $key }}">{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('formData.action')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="slaIsActive" wire:model="formData.is_active">
